...
def genTaskFinishedEvent(projectpath,task):
    ...
    fileBody+='    "'+task+'": {\n'
    fileBody+='         "foo": "example passed back data"\n'
    fileBody+='    }\n'
    fileBody+='  },\n'
    fileBody+='  "source": "keptn-project-gen",\n'
    fileBody+='  "specversion": "1.0",\n'
    fileBody+='  "type": "sh.keptn.event.'+task+'.finished",\n'
    fileBody+='  "shkeptncontext": "REPLACE_WITH_CONTEXTID_FROM_TRIGGERED_EVENT",\n'
    fileBody+='  "triggeredid": "REPLACE_WITH_ID_FROM_TRIGGERED_EVENT"\n'
    fileBody+='}\n'
